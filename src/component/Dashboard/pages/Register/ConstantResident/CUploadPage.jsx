...
class CUploadPage extends Component {
        ...
        if (e.target.files[0] !== undefined) {
            ...
            await fetch('http://api.saadatportal.com/api/v1/file', {
                ...
                .then((result) => {
                    ...
                    this.context.handleUploadedFile("constantUploadPage", "birth-page1", result.message.id)
    ...
    handleDeleteBirthPage1 = async () => {
        await fetch(`http://api.saadatportal.com/api/v1/file/${this.state.fileIdBirthPage1}`, {
            method: 'DELETE',
        })
            .then(res => res.text())
        ...
        if (e.target.files[0] !== undefined) {
            ...
            await fetch('http://api.saadatportal.com/api/v1/file', {
                ...
                .then((result) => {
                    ...
                    this.context.handleUploadedFile("constantUploadPage", "birth-page2", result.message.id);
    ...
    handleDeleteBirthPage2 = async () => {
        await fetch(`http://api.saadatportal.com/api/v1/file/${this.state.fileIdBirthPage2}`, {
            method: 'DELETE',
        })
            .then(res => res.text())
            .then(res => console.log(res));
        ...
        if (e.target.files[0] !== undefined) {
            ...
            await fetch('http://api.saadatportal.com/api/v1/file', {
                ...
                .then((result) => {
                    ...
                    this.context.handleUploadedFile("constantUploadPage", "birth-page3", result.message.id);
    ...
    handleDeleteBirthPage3 = async () => {
        await fetch(`http://api.saadatportal.com/api/v1/file/${this.state.fileIdBirthPage3}`, {
            method: 'DELETE',
        })
            .then(res => res.text())
            .then(res => console.log(res));
        ...
        if (e.target.files[0] !== undefined) {
            ...
            await fetch('http://api.saadatportal.com/api/v1/file', {
                ...
                .then((result) => {
                    ...
                    this.context.handleUploadedFile("constantUploadPage", "birth-page4", result.message.id);
    ...
    handleDeleteBirthPage4 = async () => {
        await fetch(`http://api.saadatportal.com/api/v1/file/${this.state.fileIdBirthPage4}`, {
            method: 'DELETE',
        })
            .then(res => res.text())
            .then(res => console.log(res));
        ...
        if (e.target.files[0] !== undefined) {
            ...
            await fetch('http://api.saadatportal.com/api/v1/file', {
                ...
                .then((result) => {
                    ...
                    this.context.handleUploadedFile("constantUploadPage", "birth-AllPage", result.message.id);
    ...
    handleDeleteBirthAllPage = async () => {
        await fetch(`http://api.saadatportal.com/api/v1/file/${this.state.fileIdBirthAllPage}`, {
            method: 'DELETE',
        })
            .then(res => res.text())
            .then(res => console.log(res));
        ...
        if (e.target.files[0] !== undefined) {
            ...
            await fetch('http://api.saadatportal.com/api/v1/file', {
                ...
                .then((result) => {
                    ...
                    this.context.handleUploadedFile("constantUploadPage", "card-page1", result.message.id);
    ...
    handleDeleteCartPage1 = async () => {
        await fetch(`http://api.saadatportal.com/api/v1/file/${this.state.fileIdCartPage1}`, {
            method: 'DELETE',
        })
            .then(res => res.text())
            .then(res => console.log(res));
        ...
        if (e.target.files[0] !== undefined) {
            ...
            await fetch('http://api.saadatportal.com/api/v1/file', {
                ...
                .then((result) => {
                    ...
                    this.context.handleUploadedFile("constantUploadPage", "card-page2", result.message.id);
    ...
    handleDeleteCartPage2 = async () => {
        await fetch(`http://api.saadatportal.com/api/v1/file/${this.state.fileIdCartPage2}`, {
            method: 'DELETE',
        })
            .then(res => res.text())
            .then(res => console.log(res));
        ...
        if (e.target.files[0] !== undefined) {
            ...
            await fetch('http://api.saadatportal.com/api/v1/file', {
                ...
                .then((result) => {
                    ...
                    this.context.handleUploadedFile("constantUploadPage", "card-AllPage", result.message.id);
    ...
    handleDeleteCartAllPage = async () => {
        await fetch(`http://api.saadatportal.com/api/v1/file/${this.state.fileIdCartAllPage}`, {
            method: 'DELETE',
        })
            .then(res => res.text())
            .then(res => console.log(res));
    ...
    handleDeletePersonnelImg = async () => {
        await fetch(`http://api.saadatportal.com/api/v1/file/${this.state.fileIdPersonnelImg}`, {
            method: 'DELETE',
        })
            .then(res => res.text())
            .then(res => console.log(res));
    ...
    handleDeleteRegister = async () => {
        await fetch(`http://api.saadatportal.com/api/v1/file/${this.state.fileIdRegister}`, {
            method: 'DELETE',
        })
            .then(res => res.text())
            .then(res => console.log(res));
    ...
    handleDeleteRegisterUni = async () => {
        await fetch(`http://api.saadatportal.com/api/v1/file/${this.state.fileIdRegisterUni}`, {
            method: 'DELETE',
        })
            .then(res => res.text())
            .then(res => console.log(res));
