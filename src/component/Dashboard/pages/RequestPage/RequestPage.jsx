                        ...
                        {/*<div className={'row'}>
                            {
                                this.state.requests.map(request => (
                                    <>
                                        <div className={'account-found mb-3 shadow d-flex row'}
                                             style={{height: '200px'}}>
                                            <div className={'d-flex justify-content-left col-1'}
                    ...
                    <Modal.Body className="justify-content-center">
                        ...
                        <div className={'d-flex row modal-lg'}>
                            ...
                            <div className={'col-6'}>
                                <Accordion defaultActiveKey="0"
                                           style={{
                                               backgroundColor: this.state.Validations.selectedTypeBoolean ? '' : 'rgba(255, 0, 0, 0.4)',
                                               marginTop: '-10px'
                                           }}
                                           className={'col'}
                                >
